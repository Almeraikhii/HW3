...
public class ViewYourQuestionsPage {
private final DatabaseHelper databaseHelper;
	
	public ViewYourQuestionsPage(DatabaseHelper databaseHelper) {
	...
	public void show (Stage primaryStage) {
		...
		int questions = 0; //TODO initialize this with correct value
		Text numCreated = new Text ("You have created\n" + questions + " questions so far\n");
		numCreated.setFont(StartCSE360.vrs);
		numCreated.setFill(Color.WHITE);
        ...
        rightSide.getChildren().addAll(numCreated, back);
