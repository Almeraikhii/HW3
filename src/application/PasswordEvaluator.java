...
public class PasswordEvaluator {
	...
	public static String evaluatePassword(String input) {
		...
		String errMessage = "A password must have ";
		if (!foundUpperCase)
			errMessage += "atleast 1 upper case character; ";
		
		if (!foundLowerCase)
			errMessage += "atleast 1 lower case character; ";
		
		if (!foundNumericDigit)
			errMessage += "atleast 1 numeric digits; ";
			
		if (!foundSpecialChar)
			errMessage += "atleast 1 special character; ";
			
		if (!foundLongEnough)
			errMessage += "atleast 8 characters; ";
		
		if (errMessage == "A password must have ")
			return "";
